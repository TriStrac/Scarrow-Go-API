...
type SubscriptionPlan struct {
	ID           string         `gorm:"column:plan_id;type:varchar(36);primaryKey" json:"id"`
...
type UserSubscription struct {
	ID          string    `gorm:"column:subscription_id;type:varchar(36);primaryKey" json:"id"`
	...
	Plan SubscriptionPlan `gorm:"foreignKey:PlanID;references:PlanID" json:"plan"`
}
